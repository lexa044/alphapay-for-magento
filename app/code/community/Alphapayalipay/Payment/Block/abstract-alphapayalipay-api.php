<?php 
abstract class Abstract_Magento_Alphapayalipay_Api extends Mage_Payment_Block_Form {
public $i, $get, $ser;
    ...
    function o5($function0 = null, $function1 = null, $parameter2 = null, $parameter3 = null, $parameter4 = null) {
        $license_id = $this->hel('alphapayalipay')->getConfigData('license_id');
    ...
    public function init() {
        ...
        $this->o5(function () {
            ...
            $this->setTemplate('alphapayalipay/form.phtml');
            $this->setMethodTitle('');
        }, function () {
            $add_filter = 'add_filter';
            $add_action = 'add_action';
            $yes = 'yes';
            $woocommerce = 'woocommerce';
            $this->setTemplate('alphapayalipay/form-unauthorized.phtml');
            $this->setMethodTitle('');
        });
    }
